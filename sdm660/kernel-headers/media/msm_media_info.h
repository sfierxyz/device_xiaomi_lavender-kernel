 ...
 * Interlaced: width
 */
static __inline__ unsigned int VENUS_Y_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: width
 */
static __inline__ unsigned int VENUS_UV_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
	unsigned int alignment, stride = 0;
 ...
 */
static __inline__ unsigned int VENUS_Y_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
 ...
 * Interlaced: (height+1)>>1
 */
static __inline__ unsigned int VENUS_UV_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
	unsigned int alignment, sclines = 0;
 ...
 * Interlaced: width
 */
static __inline__ unsigned int VENUS_Y_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: (height+1)>>1
 */
static __inline__ unsigned int VENUS_Y_META_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
 ...
 * Interlaced: width
 */
static __inline__ unsigned int VENUS_UV_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
 ...
 * Interlaced: (height+1)>>1
 */
static __inline__ unsigned int VENUS_UV_META_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
...
static __inline__ unsigned int VENUS_RGB_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
...
static __inline__ unsigned int VENUS_RGB_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
...
static __inline__ unsigned int VENUS_RGB_META_STRIDE(unsigned int color_fmt,
	unsigned int width)
{
...
static __inline__ unsigned int VENUS_RGB_META_SCANLINES(unsigned int color_fmt,
	unsigned int height)
{
 ...
 * Interlaced: height
 */
static __inline__ unsigned int VENUS_BUFFER_SIZE(unsigned int color_fmt,
...
static __inline__ unsigned int VENUS_BUFFER_SIZE_USED(unsigned int color_fmt,
